...
| `skill-book-close-hover-2026-09-25.png`、`skill-book-close-pressed-2026-09-25.png` | 关闭按钮悬停/按下 | `xdotool mousemove/click; DISPLAY=:100 scrot` | F161/F162 视觉状态可见，关闭后窗口隐藏。 |
